...
class Ui_main(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(150, 180, 250, 131))
    ...
    def retranslateUi(self):
        ...
        self.Dialog.setWindowTitle(_translate("Dialog", "欢迎使用智能手势识别系统"))
        self.pushButton_2.setText(_translate("Dialog", "相机模式"))

        self.label.setText(_translate("Dialog", "欢迎使用智能手势识别系统"))#
#视频界面
